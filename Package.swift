...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "git@github.com:nathanborror/swift-openai", branch: "main"),
        .package(url: "git@github.com:nathanborror/swift-ollama", branch: "main"),
        .package(url: "git@github.com:nathanborror/swift-mistral", branch: "main"),
        .package(url: "git@github.com:nathanborror/swift-perplexity", branch: "main"),
        .package(url: "git@github.com:nathanborror/swift-anthropic", branch: "main"),
        .package(url: "git@github.com:nathanborror/swift-elevenlabs", branch: "main"),
        .package(url: "git@github.com:nathanborror/swift-google-gen", branch: "main"),
        .package(url: "git@github.com:nathanborror/swift-fal", branch: "main"),
